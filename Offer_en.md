...
1.4.	Business Card (Card) – a set of data about the User or the person/organization they represent, stored in the Service database. Data entered by the User into the Card may constitute personal data.  
1.5.	Free Tariff (e.g., "Standard" category) – a version of the Service without charge, allowing the creation of a Card with a basic set of fields and functionality.  
1.6.	Paid Tariff (e.g., "Extended" category) – a version of the Service provided on a paid basis, allowing the creation of a Card with an extended set of fields and/or additional functionality.  
1.7.	Subscription – providing the User with access to Paid Tariffs for a selected period (1, 3, 6, or 12 months) on terms of 100% prepayment.  
...
3.1.3.	The User is solely responsible for maintaining the confidentiality of access to their Telegram account and for any actions performed in the Service on their behalf.  
3.1.4.	The exchange of information placed in the Card is performed through the Service exclusively at the initiative of the User via Bot or Telegram commands. The Service does not transfer or distribute information independently without receiving a command from the User through the Bot interface.  
3.2.	Free Tariff ("Standard" Category):  
3.2.1.	Provided to the User by default after starting work with the Service.  
3.2.2.	Allows creating and using a Card with a limited set of fields (e.g., Title, Description, Phone Number) determined by the Bot interface. The duration of the Free Tariff is not limited unless otherwise established by the Executor.  
3.3.	Paid Tariffs (including "Extended" Category):  
3.3.1.	Provided to the User on the terms of a paid Subscription.  
3.3.2.	Allows creating a Card with an extended set of fields (including but not limited to: E-mail, activities, website address, status, etc.) according to the functionality relevant at the time of payment.  
3.3.3.	Subscription Cost: The current cost depends on the selected period (1, 3, 6, or 12 months) and is indicated directly in the Bot interface before payment. The Executor has the right to change the cost for new Subscriptions unilaterally.  
3.3.4.	Payment is made in the currency determined by the Payment Service at the exchange rate at the time of payment.  
3.4.	Payment and Subscription Activation:  
3.4.1.	Payment is made by the User by transferring funds to the Executor via Payment Services available in the Bot (e.g., Click, Payme, bank cards, etc.).  
3.4.2.	The Subscription is considered paid and activated from the moment the Executor receives confirmation of a successful transaction from the Payment Service.  
3.4.3.	The Executor's obligations to provide access to the Paid Tariff are considered fulfilled at the moment such access is provided in the Bot interface for the paid period.  
3.4.4.	If the User refuses to use the Service before the expiration of the paid Subscription period, no refund will be made for the unused period.  
3.5.	Subscription Expiration:  
3.5.1.	The User can track the expiration date in the Bot interface.  
3.5.2.	Upon expiration, access to Paid Tariff functions is suspended, and the User is automatically moved to the Free Tariff ("Standard").  
...
4.1.3.	Block and delete the User's Account in case of violation of the Offer or legislation.  
4.1.4.	Introduce new Tariff plans, change the set of fields and functionality of existing Tariffs, notifying about this through the Bot interface or the Service's information resources.  
4.1.5.	Send information and service messages to the User.  
4.1.6.	In accordance with requests or legal requirements of law enforcement agencies, disclose or transfer to competent authorities any User information provided during the use of the Service.  
4.2.	The Executor agrees to:  
4.2.1.	Provide access to the Service in accordance with the paid Tariff.  
4.2.2.	Ensure the processing and storage of Personal Data in accordance with Section 5 of this Offer.  
4.3.	The User has the right to:  
4.3.1.	Use the Service functionality for its intended purpose.  
4.3.2.	Purchase a Subscription at any time to access Paid Plans.  
4.3.3.	Contact the Service's technical support.  
4.4.	The User undertakes.  
4.4.1.	Provide accurate data.  
4.4.2.	The User shall not use the Service to distribute or publish prohibited information.  
4.4.3.	The User undertakes to make timely payments to extend access to Paid Tariffs (if the User wishes to continue use).  
...
5.2.2.	The User acknowledges and agrees that, due to the technical architecture of the Telegram messenger, as well as for data security purposes (backups), data may be transferred, duplicated, and stored on and through servers located outside the Republic of Uzbekistan. The Executor will take all reasonable measures to protect such data.  
